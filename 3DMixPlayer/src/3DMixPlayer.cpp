/*
 * 3DMixPlayer.cpp - Standalone 3DMix Player & Visualizer for Haiku OS
 *
 * Loads and plays BeOS 3dmix projects with real-time 3D spatial audio,
 * OpenGL visualization, per-track biquad filtering and a C64-style about box.
 *
 * Extracted from VeniceDAW as a self-contained application.
 *
 * Usage: ./3DMixPlayer /path/to/project.3dmix
 */
